...
namespace Business.Tests.Services
{
    public class CalculatorTests
    {
        ...
        [TestCase(0, 100000)]
        public void MonthsLivableWithoutPay_ThrowDivideByZeroException(decimal monthlyExpenses, decimal fortune)
        {
            Assert.Throws<ArgumentException>(() => Calculator.CalculateMonthsLivableWithoutPay(fortune, monthlyExpenses));
        }
        ...
        [Test]
        public void SavingsRate_ThrowDivideByZeroException()
        {
            Assert.Throws<DivideByZeroException>(() => Calculator.SavingsRate(0, 1000));
        }
