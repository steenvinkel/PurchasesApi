...
namespace Business.Tests.Dashboard
{
    public class MonthlyAccountCategorySumsTests
    {
        ...
        {
            new object[]{ new Dictionary<MonthAndYear, Dictionary<string, decimal>>(), new MonthAndYear(2019, 9), 0m },
            new object[]{ new Dictionary<MonthAndYear, Dictionary<string, decimal>>
                { {new MonthAndYear(2019,9), new Dictionary<string, decimal> { {"Fortune", 2000m } } } },
                new MonthAndYear(2019, 9), 2000m
            },
            new object[]{ new Dictionary<MonthAndYear, Dictionary<string, decimal>>
                { {new MonthAndYear(2019,9), new Dictionary<string, decimal> { {"Investment", 3000m } } } },
                new MonthAndYear(2019, 9), 3000m
            },
            new object[]{ new Dictionary<MonthAndYear, Dictionary<string, decimal>>
                { {new MonthAndYear(2019,9), new Dictionary<string, decimal> { { "Fortune", 2000m }, { "Investment", 3000m } } } },
                new MonthAndYear(2019, 9), 5000m
            },
        };
